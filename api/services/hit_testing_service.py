...
class RetrieveResponseDict(TypedDict):
    ...
    execution_metadata: NotRequired[dict[str, float]]
...
class HitTestingService:
    ...
    def retrieve(
        ...
        execution_metadata: dict[str, float] = {}
        ...
        if metadata_filtering_conditions_raw and query:
            ...
            execution_metadata["metadata_filtering_latency"] = time.perf_counter() - start_metadata_filter

            if metadata_condition and not document_ids_filter:
                execution_metadata["total_latency"] = time.perf_counter() - start
                return cls.compact_retrieve_response(query, [], execution_metadata)
    ...
    def compact_retrieve_response(
        cls, query: str, documents: list[Document], execution_metadata: dict[str, float] | None = None
    ) -> RetrieveResponseDict:
        records = RetrievalService.format_retrieval_documents(documents)

        response: RetrieveResponseDict = {
            "query": {
                "content": query,
            },
